...
* 💡 Passionate about **Software Development**, **AI**, **ML**, and **Web Technologies**
* 📫 Reach me: **[thiru43006@gmail.com](mailto:thiru43006@gmail.com)**
...
* Managed social media content & creatives
* Enhanced brand presence with strategic planning

### **📊 Inplant Training — AIDAS Tech**

*Tidel Park, Coimbatore*

* Gained hands-on experience in data analysis using Excel

### **🤖 Internship — Training Trains**

*Erode*

* Learned the fundamentals of Artificial Intelligence

---

## 🧪 Projects

### **🔹 Employee Productivity Enhancement — A Data-Driven Approach**

* Analyzed productivity patterns to improve workforce efficiency

### **🔹 Phishing Attack Detection Using Machine Learning**

* Built ML models (SVM, RF, LR, etc.) to identify fake/malicious websites

---

## 🏆 Certifications

* **IBM (Coursera)** — Intro to Web Development (HTML, CSS, JS)
* **Udemy** — SQL for Data Analytics & BI
